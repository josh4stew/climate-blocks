...
class Prompt:
    ...
    def draw(self):
        ...
        self.drawText(self.menu_surface, self.question[1], "black", rect, self.font)
    ...
    def handle_button_click(self, label):
        if label == self.question[0]:
            ...
            print(label, " YOU got it ", self.game.tetris.score)

        else:
            self.game.tetris.score -= 50
            print(label, " Better luck next time ", self.game.tetris.score)